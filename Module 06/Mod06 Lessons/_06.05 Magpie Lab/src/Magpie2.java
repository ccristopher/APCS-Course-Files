...
public class Magpie2
{
    ...
    public String getResponse(String statement)
    {
        ...
        else if (findKeyword(statement, "Joslin", 0) >= 0)
        {
            response = "She sounds like a good teacher.";
        }
        else if (findKeyword(statement, "food", 0) >= 0)
        {
            response = "What do you like to eat?";
        }
        else if (findKeyword(statement, "school", 0) >= 0)
        {
            response = "How have your grades been?";
        }
        else if (findKeyword(statement, "neurosurgery", 0) >= 0)
        {
            response = "Tell me more about brain surgery!";
        }
