...
public class PyTheorem
{
    public static void main(String[] args)
    {
        ...
        int triangle1Side1 = (int) (Math.random() * 19 + 5);
        int triangle1Side2 = (int) (Math.random() * 19 + 5);
        ...
        int triangle2Side1 = (int) (Math.random() * 19 + 5);
        int triangle2Side2 = (int) (Math.random() * 19 + 5);
